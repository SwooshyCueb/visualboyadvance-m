...
#define stbtt_uint8  guint8
#define stbtt_int8   gint8
#define stbtt_uint16 guint16
#define stbtt_int16  gint16
#define stbtt_uint32 guint32
#define stbtt_int32  gint32
...
#define STBTT_malloc(x,u)    g_malloc(x)
#define STBTT_free(x,u)      g_free(x)
//#include <cstdlib>
